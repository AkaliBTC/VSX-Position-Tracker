    ...
    <div className="app">
      <style>{`
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        /* Number-Spinner ausblenden — Chrome blendet sie aus, Firefox/Floorp zeigt sie dauerhaft */
        input[type=number] { -moz-appearance: textfield; appearance: textfield; }
        input[type=number]::-webkit-outer-spin-button,
        input[type=number]::-webkit-inner-spin-button { -webkit-appearance: none; appearance: none; margin: 0; }
        /* Firefox/Floorp: Datums-Feld ohne aufdringliches Kalender-Icon, gleiche Optik wie Chrome */
        input[type=date] { -moz-appearance: textfield; }
        input[type=date]::-moz-calendar-picker-indicator { opacity: 0; cursor: pointer; }
        input[type=date]:hover::-moz-calendar-picker-indicator { opacity: 0.45; }
